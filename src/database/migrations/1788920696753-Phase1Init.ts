...
export class Phase1Init1788920696753 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "number_sequences" ("scope_key" character varying(100) NOT NULL, "last_value" bigint NOT NULL DEFAULT '0', CONSTRAINT "PK_cfbb34daa51aac938ba679b3044" PRIMARY KEY ("scope_key"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('SUPER_ADMIN', 'ADMIN', 'ACCOUNTANT', 'CASHIER', 'VIEWER')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_schools_code" ON "schools" ("code") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_students_identifier_code" ON "students" ("identifier_code") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_students_school_id_student_code" ON "students" ("school_id", "student_code") `);
        await queryRunner.query(`CREATE TYPE "public"."academic_years_status_enum" AS ENUM('DRAFT', 'ACTIVE', 'CLOSED')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_academic_years_school_id_name" ON "academic_years" ("school_id", "name") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_classes_school_id_academic_year_id_code" ON "classes" ("school_id", "academic_year_id", "code") `);
        await queryRunner.query(`CREATE TYPE "public"."student_classes_status_enum" AS ENUM('ACTIVE', 'LEFT')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_student_classes_student_id_academic_year_id" ON "student_classes" ("student_id", "academic_year_id") `);
        await queryRunner.query(`CREATE TYPE "public"."semesters_status_enum" AS ENUM('DRAFT', 'ACTIVE', 'CLOSED')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_semesters_academic_year_id_code" ON "semesters" ("academic_year_id", "code") `);
        ...
        await queryRunner.query(`ALTER TABLE "academic_years" ADD CONSTRAINT "FK_b293eb7909d2a3aae86c4380713" FOREIGN KEY ("school_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "classes" ADD CONSTRAINT "FK_28b990f2f869e1d1652a15388f5" FOREIGN KEY ("academic_year_id") REFERENCES "academic_years"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "student_classes" ADD CONSTRAINT "FK_544ca1c9972bb7b09d54ad11c46" FOREIGN KEY ("academic_year_id") REFERENCES "academic_years"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "semesters" ADD CONSTRAINT "FK_a2d5014975f0e10189e2dc45820" FOREIGN KEY ("academic_year_id") REFERENCES "academic_years"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "semesters" DROP CONSTRAINT "FK_a2d5014975f0e10189e2dc45820"`);
        await queryRunner.query(`ALTER TABLE "student_classes" DROP CONSTRAINT "FK_544ca1c9972bb7b09d54ad11c46"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_semesters_academic_year_id_code"`);
        await queryRunner.query(`DROP TABLE "semesters"`);
        await queryRunner.query(`DROP TYPE "public"."semesters_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_student_classes_student_id_academic_year_id"`);
        await queryRunner.query(`DROP TABLE "student_classes"`);
        await queryRunner.query(`DROP TYPE "public"."student_classes_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_classes_school_id_academic_year_id_code"`);
        await queryRunner.query(`DROP TABLE "classes"`);
        await queryRunner.query(`DROP TYPE "public"."classes_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_academic_years_school_id_name"`);
        await queryRunner.query(`DROP TABLE "academic_years"`);
        await queryRunner.query(`DROP TYPE "public"."academic_years_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_students_school_id_student_code"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_students_identifier_code"`);
